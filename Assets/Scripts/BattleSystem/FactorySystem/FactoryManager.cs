...
namespace FactorySystem
{
    ...
    {
        [Header("实体设置")]
        [SerializeField] Entity.BaseEntity[] entities;
        
        private readonly Dictionary<int, Entity.BaseEntity> entityDict = new();
        ...
        protected override void Awake()
        {
            base.Awake();
            // 暂时替代角色信息的获取
            foreach (var entity in entities) entityDict.Add(entity.entityClassID, entity);
        }
        ...
        public void CreateCharacter(FactionType factionType, int entityClassID, Vector2 position)
        {
            ...
            // 创建实体
            if (primitive is not Character charPrefab) {
